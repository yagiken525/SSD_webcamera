...
class SSD (chainer.Chain):
    ...
    def __init__(self):
        ...
        self.conv4_3_norm_mbox_priorbox = prior.prior(
            (38, 38), 30., 0, [2], 1, 1, (0.1, 0.1, 0.2, 0.2))
        self.fc7_mbox_priorbox = prior.prior(
            (19, 19), 60., 114., [2, 3], 1, 1, (0.1, 0.1, 0.2, 0.2))
        self.conv6_2_mbox_priorbox = prior.prior(
            (10, 10), 114., 168., [2, 3], 1, 1, (0.1, 0.1, 0.2, 0.2))
        self.conv7_2_mbox_priorbox = prior.prior(
            (5, 5), 168., 222., [2, 3], 1, 1, (0.1, 0.1, 0.2, 0.2))
        self.conv8_2_mbox_priorbox = prior.prior(
            (3, 3), 222., 276., [2, 3], 1, 1, (0.1, 0.1, 0.2, 0.2))
        self.pool6_mbox_priorbox = prior.prior(
